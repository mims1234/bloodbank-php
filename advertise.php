...
<div class="main_cont">
     <div class="main">
        <div class="content">
            <img src="Images/Coming-Soon.png" height="80px" style="margin:auto" /><img src="Images/camps.png" height="80px" style="margin:auto" />
            <br /><br />
...
$s="select * from advertisement";
    ...
    <tr><td style="font-size:24px; font-weight:bold; text-shadow:1px 1px 6px browm; padding-left:50px; padding-top:10px; padding-bottom:10px; color:#925959"><?php echo $data[1]; ?></td></tr>
      <tr><td align="center"> 
   <a href="pic/<?php echo $data[5] ?>"data-lightbox="image-1"> <img src="pic/<?php echo $data[3] ?>" height="250px" width="460px" style="margin:auto; padding-left:20px" /></a></td></tr>
    ...
    <tr><td>&nbsp;</td></tr>
         ...
         <tr><td>&nbsp;</td><td>&nbsp;</td></tr>
          <tr><td class="title" style="vertical-align:middle">Details:<?php echo $data[4]; ?></td></tr>
         <tr><td>&nbsp;</td><td>&nbsp;</td></tr>
