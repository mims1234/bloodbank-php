...
<tr><td class="lefttd">Pin Code</td><td><input type="text" name="t2"  value="<?php  if(isset($_POST["show"])){ echo $pin_code ;}    ?>" required="required" pattern="[0-9]{6,10}" title="please enter only numbers  between 6 to 10 for pin code"  /></td></tr> </td></tr></td></tr>
